...
!(function () {
                ...
                a = X(
                    ...
                    (e, t) =>
                        ((e) => -1 !== " \f\t\v".indexOf(e))(t) || t === fr
                            ? e.pcIsSpace || ("" === e.str && n) || (e.str.length === s.length - 1 && o) || ((e, t) => t < e.length && t >= 0 && ds(e[t]))(s, e.str.length + 1)
    ...
    const ps = (e, t = !0) =>
        ...
        Cs = (e, t) => {
            ...
            for (let t = e[o]; t; t = t[o]) if (ps(vn(t))) return void (null === (n = t.parentNode) || void 0 === n || n.removeChild(t));
        },
        ws = (e, t, n) => {
        ...
        Qs = {
            ...
            getEncodeFunc: (e, t) => {
                ...
                return o.named && o.numeric
                    ? (e, t) =>
                        e.replace(t ? Us : zs, (e) => (void 0 !== Vs[e] ? Vs[e] : void 0 !== n[e] ? n[e] : e.length > 1 ? "&#" + (1024 * (e.charCodeAt(0) - 55296) + (e.charCodeAt(1) - 56320) + 65536) + ";" : "&#" + e.charCodeAt(0) + ";"))
                    : o.named
                        ? t
                            ? (e, t) => Xs(e, t, n)
                            : Xs
        ...
        ca = (e = {}) => {
            ...
            const s = {},
                ...
                d = ((e) => {
                    ...
                    const a = (e, o = "", r = "") => {
                        ...
                        for (; i--;) {
                            const e = aa([n, o].join(" "));
                            t[a[i]] = { attributes: se(e, () => ({})), attributesOrder: e, children: se(s, N(ea)) };
                        }
                    },
                        i = (e, n) => {
                            const o = aa(e),
            ...
            e.valid_elements
                ...
                A("+ol[ul|ol],+ul[ul|ol]"),
                na({ dd: "dl", dt: "dl", li: "ul ol", td: "tr", th: "tr", tr: "tbody thead tfoot", tbody: "table", thead: "table", tfoot: "table", legend: "fieldset", area: "map", param: "video audio object" }, (e, t) => {
    ...
    const ti = (e) => {
        ...
        li = Math.round,
        di = (e) => (e ? { left: li(e.left), top: li(e.top), bottom: li(e.bottom), right: li(e.right), width: li(e.width), height: li(e.height) } : { left: 0, top: 0, bottom: 0, right: 0, width: 0, height: 0 }),
    ...
    il([{ bothErrors: ["error1", "error2"] }, { firstError: ["error1", "value2"] }, { secondError: ["value1", "error2"] }, { bothValues: ["value1", "value2"] }]);
            ...
            return void 0 !== e.replacement
                ? m(e.replacement)
                    ? 0 === e.start.length
                        ...
                        : al.value({ type: "inline-command", start: "", end: e.start, cmd: "mceInsertContent", value: e.replacement })
                ...
                show: (e, c) => {
                    ...
                    if (!n(c))
                        return (
                            ...
                            Ec(a.nextSibling) ? (u.setStart(a, 0), u.setEnd(a, 0)) : (u.setStart(a, 1), u.setEnd(a, 1)),
                            u
                        );
                    {
                        const n = ((e, t, n) => {
            ...
            ((e, t, n = !1) =>
                2 === t
                    ...
                    : 3 === t
                        ? ((e) => {
                            const t = e.getRng();
                            return { start: Wi(e.dom.getRoot(), Mi.fromRangeStart(t)), end: Wi(e.dom.getRoot(), Mi.fromRangeEnd(t)), forward: e.isForward() };
                        })(e)
                        : t
            ...
            ((e, t) => {
                ...
                if (t) {
                    if (_u(t))
                        return ((e, t) => {
                            const n = e.createRng();
                            return Tu(e, !0, t, n) && Tu(e, !1, t, n) ? I.some({ range: n, forward: Nu(t) }) : I.none();
                        })(n, t);
                    if (((e) => m(e.start))(t))
                        return ((e, t) => {
                            ...
                            return Lt(n, o, (n, o) => {
                                const r = e.createRng();
                                return r.setStart(n.container(), n.offset()), r.setEnd(o.container(), o.offset()), { range: r, forward: Nu(t) };
                            });
                        })(n, t);
                    if (((e) => ke(e, "id"))(t))
                        return ((e, t) => {
                            ...
                            return Lt(n, o.or(n), (n, o) => {
                                const r = e.createRng();
                                return r.setStart(Ru(e, n.container()), n.offset()), r.setEnd(Ru(e, o.container()), o.offset()), { range: r, forward: Nu(t) };
                            });
                        })(n, t);
                    if (Su(t))
                        return ((e, t) =>
    ...
    const Uu = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
        ...
        zm = (e, t, n, o = !1) => {
            ...
            return (
                ...
                jo(a) && a.hasChildNodes() && ((a = hi(a, t.collapsed ? i : i - 1)), Xo(a) && (i = a.data.length)),
                (r = Om(e, r)),
                (a = Om(e, a)),
                Um(r) && ((r = _m(r) ? r : r.parentNode), (r = t.collapsed ? r.previousSibling || r : r.nextSibling || r), Xo(r) && (s = t.collapsed ? r.length : 0)),
                Um(a) && ((a = _m(a) ? a : a.parentNode), (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a), Xo(a) && (i = t.collapsed ? 0 : a.length)),
                t.collapsed &&
                ...
                (Em(l) || l.block_expand) && ((Em(l) && Xo(r) && 0 !== s) || (r = Fm(e, n, r, s, !0)), (Em(l) && Xo(a) && i !== a.data.length) || (a = Fm(e, n, a, i, !1))),
                Sm(l) && ((r = Lm(e, n, t, r, "previousSibling")), (a = Lm(e, n, t, a, "nextSibling"))),
                (xm(l) || km(l)) && ((r = Mm(e, n, r, "previousSibling")), (a = Mm(e, n, a, "nextSibling")), xm(l) && (e.isBlock(r) || (r = Fm(e, n, r, s, !0)), e.isBlock(a) || (a = Fm(e, n, a, i, !1)))),
    ...
    const Gm = (e, t, n) => !n.collapsed && $(n.getClientRects(), (n) => ((e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom)(n, e, t)),
            ...
            const x = (e) => C(e) && (or(e) || n.is(e, "figure.image")),
                ...
                A = (e) => {
                    ...
                    (o = e.screenX - u),
                        ...
                        c && (of(o) > of(r) ? ((v = rf(b * p)), (b = rf(v / p))) : ((b = rf(v / p)), (v = rf(b * p)))),
                        R(i, b, v),
                        (C = d.startPos.x + o),
                        (E = d.startPos.y + r),
                        (C = C > 0 ? C : 0),
        ...
        cf = il([{ ltr: ["start", "soffset", "finish", "foffset"] }, { rtl: ["start", "soffset", "finish", "foffset"] }]),
    ...
    const mf = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
        ...
        pf = { before: gf.before, on: gf.on, after: gf.after, cata: (e, t, n, o) => e.fold(t, n, o), getStart: (e) => e.fold(R, R, R) },
        hf = il([{ domRange: ["rng"] }, { relative: ["startSitu", "finishSitu"] }, { exact: ["start", "soffset", "finish", "foffset"] }]),
        bf = {
            ...
            getWin: (e) => {
                const t = ((e) => e.match({ domRange: (e) => vn(e.startContainer), relative: (e, t) => pf.getStart(e), exact: (e, t, n, o) => e }))(e);
                return Nn(t);
            },
            range: mf,
        },
            ...
            return ((e, t) => {
                const n = ((e, t) =>
                    t.match({
                        ...
                        relative: (t, n) => ({ ltr: Pe(() => lf(e, t, n)), rtl: Pe(() => I.some(lf(e, n, t))) }),
                        exact: (t, n, o, r) => ({ ltr: Pe(() => df(e, t, n, o, r)), rtl: Pe(() => I.some(df(e, o, r, t, n))) }),
                    }))(e, t);
                return ((e, t) => {
                    const n = t.ltr();
                    return n.collapsed
                        ? t
                            ...
                            .map((e) => cf.rtl(vn(e.endContainer), e.endOffset, vn(e.startContainer), e.startOffset))
            ...
            const a = ((e, t) => {
                const n = ((e, t) => {
                    ...
                    if (t < n.length && !Uf(n[t])) return { element: n[t], offset: 0 };
                    {
                        ...
                        return Uf(o) ? { element: e, offset: t } : "img" === jt(o) ? { element: o, offset: 1 } : Wt(o) ? { element: o, offset: hr(o).length } : { element: o, offset: Ln(o).length };
                    }
                })(e, t),
    ...
    const pg = Oa.DOM,
        ...
        yg = (e, t) => {
            ...
            n.on("focusin", () => {
                ...
                hg(vg(n)) && o(n, cn), t !== n && (t && t.dispatch("blur", { focusedEditor: n }), e.setActive(n), (e.focusedEditor = n), n.dispatch("focus", { blurredEditor: t }), n.focus(!0));
            }),
                n.on("focusout", () => {
                    fg.setEditorTimeout(n, () => {
                        const t = e.focusedEditor;
                        (hg(vg(n)) && t === n) || o(n, mn), bg(n, vg(n)) || t !== n || (n.dispatch("blur", { focusedEditor: null }), (e.focusedEditor = null));
                    });
                }),
                gg ||
                ((gg = (t) => {
                    ...
                    n &&
                        Wn(t).each((t) => {
                            const o = t;
                            o.ownerDocument === document && (o === document.body || bg(n, o) || e.focusedEditor !== n || (n.dispatch("blur", { focusedEditor: null }), (e.focusedEditor = null)));
                        });
                }),
        ...
        wg = (e, t) => {
            ((e, t) => ((e) => (e.collapsed ? I.from(hi(e.startContainer, e.startOffset)).map(vn) : I.none()))(t).bind((t) => (_r(t) ? I.some(t) : En(e, t) ? I.none() : I.some(e))))(vn(e.getBody()), t)
                .bind((e) => Cu(e.dom))
                .fold(
                    () => {
        ...
        Pg = (e) => Zn(e, Bg),
        Lg = { "#text": 3, "#comment": 8, "#cdata": 4, "#pi": 7, "#doctype": 10, "#document-fragment": 11 },
        Mg = (e, t, n) => {
                        ...
                        : "text" === t.format
                            ? ((e, t) => {
                                const n = e.getDoc(),
                                    o = $n(vn(e.getBody())),
                                    r = hn("div", n);
                                Qt(r, "data-mce-bogus", "all"), ao(r, { position: "fixed", left: "-9999999px", top: "0" }), Eo(r, t.innerHTML), Vg(r), qg(r);
    ...
    const Qg = ["font", "text-decoration", "text-emphasis"],
            ...
            ((e, t, n) =>
                e
                    ? ((e, t) =>
                        Jp(t)
                            .orThunk(() => Qp(t))
                            .orThunk(() => ((e, t) => vu(e, Mi.after(t)).orThunk(() => yu(e, Mi.before(t))))(e, t)))(t, n)
                    : ((e, t) =>
                        Qp(t)
                            .orThunk(() => Jp(t))
                            .orThunk(() =>
        ...
        wh = il([{ singleCellTable: ["rng", "cell"] }, { fullTable: ["table"] }, { partialTable: ["cells", "outsideDetails"] }, { multiTable: ["startTableCells", "endTableCells", "betweenRng"] }]),
                            ...
                            : ((e, t, n, o, r) =>
                                pu(n, e.getBody(), r).fold(
                                    ...
                                    (s) =>
                                        ((e, t, n, o) =>
                                            Cu(e.dom)
                                                .bind((r) => wu(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r))))
                                                .getOr(!0))(o, n, r, s)
                                            ? ((e, t) => zh(e, t))(e, o)
                                            : ((e, t, n) =>
            ...
            return e.selection.isCollapsed() && 0 === o.length
                ...
                : ((e, t, n) => {
                    ...
                    return 0 !== n.length
                        ...
                        : ((e, t, n, o) =>
                            Uh(t, o).fold(
                                () => ((e, t, n) => Oh(t, n).bind((t) => t.fold(O(Mh, e), O(Ih, e), O(Ph, e), O(Lh, e))))(e, t, n),
                                (t) => ((e, t) => zh(e, t))(e, t)
                            ))(e, o, r, t);
                })(e, n, o);
        },
        ...
        xb = (e, t, n, o, r, s) => {
            ...
            if (a)
                if (_e(a)) {
                    for (let n = 0; n < a.length; n++) if (i ? e.getAttrib(t, a[n]) : vm(e, t, a[n])) return !0;
                } else
                    for (const o in a)
                        if (ke(a, o)) {
        ...
        Rb = (e) => {
            const t = hn("span");
            return Jt(t, { id: xu, "data-mce-bogus": "1", "data-mce-type": "format-caret" }), e && ho(t, bn(Sb)), t;
        },
        Ab = (e, t, n = !0) => {
            const o = e.dom,
                r = e.selection;
                    ...
                    const s = e.formatter.get(t),
                            ...
                            return ((e, t, n, o, r, s, a, i) => {
                                ...
                                if (n) {
                                    ...
                                    (a.mixed && m.isBlock(n)) || (o = null !== (l = m.split(n, o)) && void 0 !== l ? l : o),
                                        c && u && (null === (d = r.parentNode) || void 0 === d || d.insertBefore(c, r), u.appendChild(r), Em(a) && Xb(e, a, 0, c));
                                }
                                return o;
                            })(e, s, i, o, o, 0, a, n);
                        },
                        ...
                        u = (t) => {
                            const n = ce(t.childNodes),
                                o = c(t) || $(s, (e) => wb(i, t, e)),
                                r = t.parentNode;
                            if ((!o && C(r) && Sm(a) && c(r), a.deep && n.length)) for (let e = 0; e < n.length; e++) u(n[e]);
                            q(["underline", "line-through", "overline"], (n) => {
                                jo(t) && e.dom.getStyle(t, "text-decoration") === n && t.parentNode && ym(i, t.parentNode) === n && hv(e, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: n } }, void 0, t);
                            });
                        },
                        m = (e) => {
                            ...
                            if (t) {
                                ...
                                return (
                                    ((e) => Mu(e) && jo(e) && ("_start" === e.id || "_end" === e.id))(n) && (n = n[e ? "firstChild" : "lastChild"]),
                            ...
                            if (a.split) {
                                if (((r = Df(r)), (n = sv(e, r, !0)), (o = sv(e, r)), n !== o)) {
                                    if (((n = av(n, !0)), (o = av(o, !1)), rv(i, n, o))) {
                                        ...
                                        return d(lv(i, e, !0, "span", { id: "_start", "data-mce-type": "bookmark" })), void m(!0);
                                    }
                                    if (rv(i, o, n)) {
                                        const e = I.from(o.lastChild).getOr(o);
                                        return d(lv(i, e, !1, "span", { id: "_end", "data-mce-type": "bookmark" })), void m(!1);
                                    }
                                    (n = iv(i, n, "span", { id: "_start", "data-mce-type": "bookmark" })), (o = iv(i, o, "span", { id: "_end", "data-mce-type": "bookmark" }));
                                    const e = i.createRng();
                                    e.setStartAfter(n),
                                        e.setEndBefore(o),
                                        jm(i, e, (e) => {
                    ...
                    a && Em(s) && !Xu(e).length
                        ? ((e, t, n) => {
                            ...
                            if (l && i > 0 && i < l.length && d.test(l.charAt(i)) && d.test(l.charAt(i - 1))) {
                                ...
                                let s = o ? Nb(o) : null;
                                (o && (null == s ? void 0 : s.data) === Sb) || ((c = e.getDoc()), (u = Rb(!0).dom), (o = c.importNode(u, !0)), (s = o.firstChild), a.insertNode(o), (i = 1)),
            ...
            ge(n, (n, r) => {
                const s = (n) => {
                    ...
                    if (n.state.get() !== a) {
                        n.state.set(a);
                        const e = s.getOr(t);
                        xv(n) ? n.callback(a, { node: e, format: r, parents: o }) : q(n.callbacks, (t) => t(a, { node: e, format: r, parents: o }));
                    }
                };
        ...
        My = (function e() {
            ...
            var Re = function (e) {
                ...
                Oe = function (e) {
                    ...
                    /*"application/xhtml+xml" === T && (e = '<html xmlns="f"><head></head><body>' + e + "</body></html>");*/
                ...
                Pe = function (e) {
                    ...
                    if (
                        (De("uponSanitizeElement", e, { tagName: r, allowedTags: z }),
                            e.hasChildNodes() && !Be(e.firstElementChild) && (!Be(e.content) || !Be(e.content.firstElementChild)) && cy(/<[/\w]/g, e.innerHTML) && cy(/<[/\w]/g, e.textContent))
                    )
                        return Re(e), !0;
                    ...
                    return e instanceof l &&
                        ...
                        : ("noscript" !== r && "noembed" !== r) || !cy(/<\/no(script|embed)/i, e.innerHTML)
                            ? (X && 3 === e.nodeType && ((t = e.textContent), (t = iy(t, D, " ")), (t = iy(t, P, " ")), e.textContent !== t && (ry(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
                ...
                Le = function (e, t, n) {
                    ...
                    if (G && !W[t] && cy(L, t));
                        ...
                        if (
                            !(
                                (Me(e) &&
                                    ((V.tagNameCheck instanceof RegExp && cy(V.tagNameCheck, e)) || (V.tagNameCheck instanceof Function && V.tagNameCheck(e))) &&
                                    ((V.attributeNameCheck instanceof RegExp && cy(V.attributeNameCheck, t)) || (V.attributeNameCheck instanceof Function && V.attributeNameCheck(t)))) ||
                                ("is" === t && V.allowCustomizedBuiltInElements && ((V.tagNameCheck instanceof RegExp && cy(V.tagNameCheck, n)) || (V.tagNameCheck instanceof Function && V.tagNameCheck(n))))
                            )
                        )
                            return !1;
                    } else if (ue[t]);
            ...
            return (
                (n.sanitize = function (e, r) {
                    ...
                    return (
                        Q && z["!doctype"] && a.ownerDocument && a.ownerDocument.doctype && a.ownerDocument.doctype.name && cy(Py, a.ownerDocument.doctype.name) && (g = "<!DOCTYPE " + a.ownerDocument.doctype.name + ">\n" + g),
                        X && ((g = iy(g, D, " ")), (g = iy(g, P, " "))),
        ...
        Hy = (e, t, n) => {
            ...
            return (
                ...
                (!!/((java|vb)script|mhtml):/i.test(o) ||
                    (!e.allow_html_data_urls && (/^data:image\//i.test(o) ? ((e, t) => (C(e) ? !e : !C(t) || !H(jy, t)))(e.allow_svg_data_urls, n) && /^data:image\/svg\+xml/i.test(o) : /^data:/i.test(o))))
            );
        };
    class $y {
    ...
    const Ky = (e, t, n, o) => {
            ...
            return (
                ...
                n.addHook("uponSanitizeAttribute", (n, o) => {
                    ...
                    (o.keepAttr = Gy(e, t, r, s, a)),
                        o.keepAttr ? ((o.allowedAttributes[s] = !0), Xy(s, t) && (o.attrValue = s), e.allow_svg_data_urls && He(a, "data:image/svg+xml") && (o.forceKeepAttr = !0)) : Yy(n, s) && (o.forceKeepAttr = !0);
                }),
                n
            );
        },
        ...
        oC = (e, t, n) => {
            ...
            if (fb(e)) {
                if (r.content !== o) {
                    const t = nC({ validate: !1, forced_root_block: !1, sanitize: n }).parse(r.content, { context: e.name });
                    return { ...r, content: t };
                }
                return { ...r, content: e };
            }
        ...
        aC = (e, t) => {
            if (t.no_events) return al.value(t);
            {
                const n = oC(t.content, (n) => ((e, t) => e.dispatch("BeforeSetContent", t))(e, { ...t, content: n }), rc(e));
        ...
        NC = (e, t, n) => {
            ...
            "fragmented" === t.type ? EC(t.fragments, e.getBody()) : e.setContent(t.content, { format: "raw", no_selection: !C(o) || !_u(o) || !o.isFakeCaret }), o && (e.selection.moveToBookmark(o), e.selection.scrollIntoView());
        },
        ...
        PC = (e) => ({
            ...
            undoManager: {
                ...
                undo: (t, n, o) =>
                    ((e, t, n, o) => {
                        let r;
                        return t.typing && (t.add(), (t.typing = !1), BC(t, !1, n)), o.get() > 0 && (o.set(o.get() - 1), (r = t.data[o.get()]), NC(e, r, !0), e.setDirty(!0), e.dispatch("Undo", { level: r })), r;
                    })(e, t, n, o),
                redo: (t, n) =>
                    ((e, t, n) => {
                        let o;
                        return t.get() < n.length - 1 && (t.set(t.get() + 1), (o = n[t.get()]), NC(e, o, !1), e.setDirty(!0), e.dispatch("Redo", { level: o })), o;
                    })(e, t, n),
                clear: (t, n) =>
                    ((e, t, n) => {
                ...
                closest: (t) =>
                    ((e, t) => {
                        ...
                        return I.from(e.selection.getStart(!0))
                            .bind((o) => bb(vn(o), (n) => ue(t, (t) => ((t, n) => (kb(e, t.dom, n) ? I.some(n) : I.none()))(n, t)), n))
                            .getOrNull();
                    })(e, t),
                                ...
                                fb(t)
                                    ...
                                    : ((e, t, n, o) => {
                                        if (0 === n.length || /^\s+$/.test(n)) {
                                            ...
                                            const s = Rl(e);
                                            return e.schema.isValidChild(t.nodeName.toLowerCase(), s.toLowerCase()) ? ((n = r), (n = e.dom.createHTML(s, Al(e), n))) : n || (n = r), gb(e, n, o.no_selection), { content: n, html: n };
                                        }
                                        {
                                            "raw" !== o.format && (n = Yg({ validate: !1 }, e.schema).serialize(e.parser.parse(n, { isRootContent: !0, insert: !0 })));
                        ...
                        ((e, t) => {
                            ...
                            t.collapsed ||
                                (n === o && s - r < 2 && n.hasChildNodes() && (a = n.childNodes[r]),
                                    Xo(n) && Xo(o) && ((n = n.length === r ? Rg(n.nextSibling, !0) : n.parentNode), (o = 0 === s ? Rg(o.previousSibling, !1) : o.parentNode), n && n === o && (a = n)));
    ...
    const Rw = (e, t) => {
        ...
        Aw = (e) => () => e.notificationManager.open({ text: e.translate("Image uploading..."), type: "info", timeout: -1, progressBar: !0 }),
                                            ...
                                            n.status && Il(e)
                                                ? (n.url && !je(l.src, n.url) && (s = !0),
                                                    ...
                                                    ((t, n) => {
                                                        ...
                                                        var r;
                                                        d(t.src, n), Jt(vn(t), { src: Ml(e) ? ((r = n), r + (-1 === r.indexOf("?") ? "?" : "&") + new Date().getTime()) : n, "data-mce-src": o });
                                                    })(l, n.url))
                                                : n.error &&
            ...
            const t = za(),
                ...
                r = {
                    ...
                    dispatchChange: () => {
                        e.setDirty(!0);
                        const t = _C(e);
                        (t.bookmark = ol(e.selection)), e.dispatch("change", { level: t, lastLevel: ie(r.data, o.get()).getOrUndefined() });
                    },
                    ...
                    e.on("init", () => {
                        ...
                        e.on("keyup", (n) => {
                            ...
                            ((s >= 33 && s <= 36) || (s >= 37 && s <= 40) || 45 === s || n.ctrlKey || a) && (r(), e.nodeChanged()),
                                ...
                                o.get() && t.typing && !OC(_C(e), t.data[0]) && (e.isDirty() || e.setDirty(!0), e.dispatch("TypingUndo"), o.set(!1), e.nodeChanged());
                        }),
                        e.on("keydown", (e) => {
                            const s = e.keyCode;
                                        ...
                                        Xw(e, n).map((n) =>
                                            ((e, t, n) =>
                                                nr(n.position.getNode()) && !ps(n.block)
                                                    ? bu(!1, n.block.dom)
                                                        .bind((o) => (o.isEqual(n.position) ? gu(t, e, o).bind((t) => Xw(e, t)) : I.some(n)))
                                                        .getOr(n)
                                                    : n)(e, t, n)
                                        )
                                    )
        ...
        vx = il([{ remove: ["element"] }, { moveToElement: ["element"] }, { moveToPosition: ["position"] }]),
        yx = (e, t, n) =>
            gu(t, e, n).bind((o) => {
                return (
                    (r = o.getNode()),
                ...
                .fold(
                    () =>
                        ((e, t, n) => {
                                        ...
                                        : t && gp(r) && Np(s, r)
                                            ...
                                            : ((e, t, n) =>
                                                ((e, t) => {
                                                    ...
                                                    ? ((e, t) => (y(t) ? I.none() : e && sr(t.nextSibling) ? I.some(vx.moveToElement(t.nextSibling)) : !e && sr(t.previousSibling) ? I.some(vx.moveToElement(t.previousSibling)) : I.none()))(
                                                        t,
                                                        n.getNode(!t)
                                                    ).orThunk(() => yx(e, t, n))
                                                    : yx(e, t, n).bind((t) =>
                            ...
                            n.fold(
                                ((e, t) => (n) => (e._selectionOverrides.hideFakeCaret(), oh(e, t, vn(n)), !0))(e, t),
                                ((e, t) => (n) => {
        ...
        Mx = il([{ before: ["element"] }, { start: ["element"] }, { end: ["element"] }, { after: ["element"] }]),
        Ix = (e, t) => Uc(t, e) || e,
        Fx = (e, t, n) => {
            const o = dh(n),
                r = Ix(t, o.container());
    ...
    const tk = (e, t) => (e === Zc.Backwards ? oe(t) : t),
        ...
        rk = (e, t, n, o) => {
            ...
            for (; s;) {
                const n = nk(t, r, s);
                if (!n) break;
                if (nr(n.getNode(!1))) return t === Zc.Forwards ? { positions: tk(t, a).concat([n]), breakType: ek.Br, breakAt: I.some(n) } : { positions: tk(t, a), breakType: ek.Br, breakAt: I.some(n) };
                if (n.isVisible()) {
                    if (e(s, n)) {
                        const e = ok(0, t, s, n);
    ...
    const wk = (e, t, n, o, r, s) => {
            ...
            if (e.selection.isCollapsed() && cd(e)) {
                ...
                return ((e, t, n, o) => {
                    const r = ((e, t) => Uc(t, e) || e)(e.getBody(), o.container()),
                        ...
                        a = qx(s, r, o);
                    return a
                        .bind((e) => (n ? e.fold(N(I.some(Yx(e))), I.none, N(I.some(Gx(e))), I.none) : e.fold(I.none, N(I.some(Gx(e))), I.none, N(I.some(Yx(e))))))
                        .map($k(e, t))
                        .getOrThunk(() => {
                            const i = pu(n, r, o),
                                l = i.bind((e) => qx(s, r, e));
        ...
        FE = (e, t) => J(((e, t) => te(((e) => V(e, (e) => ({ ...LE, ...e })))(e), (e) => (ME(e, t) ? [e] : [])))(e, t), (e) => e.action()),
        UE = (e, t) => ue(((e, t) => te(((e) => V(e, (e) => ({ ...LE, ...e })))(e), (e) => (ME(e, t) ? [e] : [])))(e, t), (e) => e.action()),
        zE = (e, t) => {
            const n = t ? Zc.Forwards : Zc.Backwards,
                o = e.selection.getRng();
        ...
        $E = il([{ none: ["current"] }, { first: ["current"] }, { middle: ["current", "target"] }, { last: ["current"] }]),
        ...
        YE = (e, t, n, o, r) => {
            const s = Mo(vn(n), "td,th,caption").map((e) => e.dom),
                a = G(
                    ((e, t) =>
                        te(t, (t) => {
                            const n = ((e, t) => ({ left: e.left - t, top: e.top - t, right: e.right + -2, bottom: e.bottom + -2, width: e.width + t, height: e.height + t }))(di(t.getBoundingClientRect()), -1);
                            return [
        ...
        JE = (e, t, n) => {
            const o = e(t, n);
            return ((e) => e.breakType === ek.Wrap && 0 === e.positions.length)(o) || (!nr(n.getNode()) && ((e) => e.breakType === ek.Br && 1 === e.positions.length)(o))
        ...
        cS = (e, t) => {
            ...
            return ((e, t) => ((e, t, n = L) => (n(t) ? I.none() : H(e, jt(t)) ? I.some(t) : Jn(t, e.join(","), (e) => wn(e, "table") || n(e))))(["td", "th"], e, t))(vn(t ? s.endContainer : s.startContainer), r)
                .map(
                    (n) => (
                        WE(n, r).each((t) => {
                ...
                () =>
                    ((e, t, n, o = 0) => {
                        ...
                        return bS(
                            ...
                            const s = vS(r);
                            return 0 !== s.lastIndexOf(n) || CS(s, n).length < o ? I.none() : I.some({ text: CS(s, n), range: r, trigger: n });
                        });
                    })(e, t, n, o),
                (t) => {
                    const o = e.createRng();
    ...
    const _S = (e, t, n) => (e.stype === SS.Error ? t(e.serror) : n(e.svalue)),
            ...
            extract: (n, o) =>
                xe(o, e).fold(
                    ...
                    (e) =>
                        ((e, t, n, o) =>
                            xe(n, o).fold(
                                () => ((e, t, n) => TS(e, () => 'The chosen schema: "' + n + '" did not exist in branches: ' + OS(t)))(e, n, o),
                ...
                a = (e) =>
                    e.fold(
                        ...
                        (e) => {
                            ...
                            return (s = n), (a = I.some), s.stype === SS.Value ? { stype: SS.Value, svalue: a(s.svalue) } : s;
                            var s, a;
                        }
                    );
            switch (e.tag) {
        ...
        VS = (e, t, n) => {
            return (o = ((e, t, n) => ((e, t) => (e.stype === SS.Error ? { stype: SS.Error, serror: t(e.serror) } : e))(t.extract([e], n), (e) => ({ input: n, errors: e })))(e, t, n)), _S(o, al.error, al.value);
            var o;
        },
        qS = (e, t) => BS(e, pe(t, HS)),
        WS = N(US),
    ...
    HS([w_("contextform"), d_("initValue", N("")), b_, ((e, t) => JS(e, e, { tag: "required", process: {} }, $S(t)))("commands", T_), o_("launch", qS("type", { contextformbutton: A_, contextformtogglebutton: O_ }))].concat(__));
    const B_ = (e) => {
        ...
        vN = (e, t, n) => {
            t.selection.isCollapsed() ||
                ...
                (C(n) && M_(t, e.fakeEventName).isDefaultPrevented()) || (e.insert(t, n), C(n) && L_(t, e.fakeEventName));
        },
        yN = (e, t) => {
            const n = () => vN(rN, e, t),
                o = () => vN(X_, e, t),
                            ...
                            e.on("keyup", (t) => {
                                t.isDefaultPrevented() ||
                                    ((e, t, n) => {
                                        ...
                                        r.isMacOS() && n && a.push({ keyCode: s.isFirefox() ? 224 : 91, action: IE(nE, e) }), FE([{ keyCode: tf.BACKSPACE, action: IE(xx, e) }, { keyCode: tf.DELETE, action: IE(xx, e) }, ...a], t);
                                    })(e, t, n),
                                    (n = !1);
                            });
                    })(e, t),
                            ...
                            t.isDefaultPrevented() ||
                                ((e, t) => {
                                    UE(
                                        ...
                                        t.preventDefault(), M_(e, "insertText", { data: " " }).isDefaultPrevented() || (n(), L_(e, "insertText", { data: " " }));
                                    });
                                })(e, t);
                        });
                    })(e),
        ...
        constructor(e) {
            ...
            "onselectionchange" in e.getDoc() ||
                ...
                e.on("SelectionChange", () => {
                    ...
                    t && nm(e) && !n.isSameElementPath(t) && e.dom.isChildOf(t, e.getBody()) && e.nodeChanged({ selectionChange: !0 });
                }),
                e.on("mouseup", (t) => {
                    !t.isDefaultPrevented() &&
                        nm(e) &&
    ...
    const $N = ti("mode"),
        ...
        CR = (e, t, n, o, r) => {
            ...
            if (!s.cancelled) {
                ...
                r ? M_(e, "insertFromPaste", { dataTransfer: yR(t) }).isDefaultPrevented() || (n(), L_(e, "insertFromPaste")) : n();
            }
        },
        wR = (e, t, n, o) => {
            const r = n || aR(t);
        ...
        TR = (e) => ({ html: sR(e.selection.getContent({ contextual: !0 })), text: e.selection.getContent({ format: "text" }) }),
        ...
        YR = (e, t, n) => {
            ...
            return !(
                ...
                !(l && a && ((e, t) => t.startSummary.exists((t) => ((e, t) => Cu(t).exists((t) => t.isEqual(e)))(e, t)))(d, t)) &&
                !(l && i && ((e, t) => t.startSummary.exists((t) => ((e, t) => wu(t).exists((n) => (nr(n.getNode()) && yu(t, n).exists((t) => t.isEqual(e))) || n.isEqual(e)))(e, t)))(d, t)) &&
                !(l && a && ((e, t) => t.startDetails.exists((n) => yu(n, e).forall((n) => t.startSummary.exists((t) => !t.contains(e.container()) && t.contains(n.container())))))(d, t)) &&
                !(l && i && ((e, t, n) => n.startDetails.exists((n) => vu(e, t).forall((e) => !n.contains(e.container()))))(c, d, t)) &&
                (!qR ||
                    !ur(r) ||
                    ((!l && jR(s, r)) || hh(i, d, r)
                        ? UR(r)
                        : e.undoManager.transact(() => {
                            const t = o.getSel();
                            let { anchorNode: s, anchorOffset: i, focusNode: d, focusOffset: c } = null != t ? t : {};
                            const u = () => {
                            ...
                            m(r, f),
                                r.appendChild(f),
                                u(),
                                l && ((WR && (n.altKey || (a && n.metaKey))) || (!WR && n.ctrlKey)) && (null == t || t.modify("extend", a ? "left" : "right", n.metaKey ? "line" : "word")),
    ...
    const sA = (e, t) => Math.abs(e.left - t),
        ...
        cA = (e, t, n) =>
            ((e, t, n) => {
                ...
                .filter((e) => Sc(e.node))
                .map((e) => ((e, t) => ({ node: e.node, position: sA(e, t) < aA(e, t) ? rA.Before : rA.After }))(e, t)),
        uA = (e) => {
            var t, n;
                            ...
                            return ((o) => {
                                ...
                                const d = ((o, r) => {
                                    const a = vn(e.getBody()),
                                        ...
                                        d = n.createRng();
                                    yo(l), vo(l, [bn(fr, i), vn(r), bn(fr, i)]), d.setStart(l.dom.firstChild, 1), d.setEnd(l.dom.lastChild, 0), ao(l, { top: n.getPos(o, e.getBody()).y + "px" }), tg(l);
                                    const c = t.getSel();
                            ...
                            !((e, t, n) => {
                                const o = vn(e.getBody()),
                                    ...
                                    s = ((e, t, n, o) => {
                                        ...
                                        return { x: n - (e ? r.left + t.dom.clientLeft + gw(t) : 0), y: o - (e ? r.top + t.dom.clientTop + fw(t) : 0) };
                                    })(e.inline, r, t, n);
                                return ((e, t, n) => {
                                    const o = uw(e),
                                        r = mw(e);
        ...
        PA = (e, t) => {
            const n = t.slice(),
                o = n.pop();
            return x(o) ? X(n, (e, t) => e.bind((e) => I.from(e.childNodes[t])), I.some(e)).bind((e) => (Xo(e) && (o < 0 || o > e.data.length) ? I.none() : I.some({ node: e, offset: o }))) : I.none();
        },
        LA = (e, t) =>
        ...
        IA = (e, t, n, o = !0) => {
            ...
            t.deleteContents(),
                o &&
                !n(t.startContainer) &&
                (Xo(t.startContainer) && 0 === t.startContainer.data.length && e.remove(t.startContainer), Xo(t.endContainer) && 0 === t.endContainer.data.length && e.remove(t.endContainer), MA(e, r, n), r !== s && MA(e, s, n));
        },
        FA = (e, t) => I.from(e.dom.getParent(t.startContainer, e.dom.isBlock)),
        UA = (e, t, n) => {
            const o = e.dynamicPatternsLookup({ text: n, block: t });
            return { ...e, blockPatterns: ul(o).concat(e.blockPatterns), inlinePatterns: ml(o).concat(e.inlinePatterns) };
        },
        zA = (e, t, n, o) => {
            const r = e.createRng();
        ...
        VA = (e, t, n) => {
            const o = LA(e.getRoot(), n).getOrDie("Unable to resolve path range"),
                ...
                l = i.parentNode;
            return { prefix: t, end: a.parentNode.insertBefore(HA(e, t + "-end"), a), start: l.insertBefore(HA(e, t + "-start"), i) };
        },
        qA = (e, t, n) => {
            ...
            return pS(i, l - n.pattern.end.length, t).bind((d) => {
                ...
                if (WA(a)) return I.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d });
                {
                    ...
                    return m.map((e) => {
                        ...
                        return { matches: l.matches.concat([{ pattern: a, startRng: t, endRng: c }]), position: uS(e.startContainer, e.startOffset) };
                    });
                }
            });
        },
        ...
        QA = (e, t, n, o, r, s) => {
            ...
            return ((e, t) => {
                ...
                YA(e, ((a = r.inlinePatterns), ae(a, (e, t) => t.end.length - e.end.length)), n, o, t, s).fold(
                    () => [],
                    (e) => e.matches
                )
            );
                    ...
                    const s = Math.max(0, n.startOffset),
                        ...
                        l = ((e, t, n, o) => {
                            ...
                            return ((e, t) => {
                                ...
                                .map((e) => (Dt.trim(i).length === e.start.length ? [] : [{ pattern: e, range: DA(s, s.getRoot(), t, 0, t, 0, true) }]))
                                .getOr([]);
                        })(e, o, a);
                    return (
        ...
        dO = (e) => {
            !0 !== e.removed &&
                (((e) => {
                    LC(e) || e.load({ initial: !0, format: "html" }), (e.startContent = e.getContent({ format: "raw" }));
                })(e),
                    ((e) => {
        ...
        cO = (e) => {
            ...
            (o.disabled = !0),
                ...
                !e.readonly && e.hasEditableRoot() && (e.inline && "static" === nO.getStyle(o, "position", !0) && (o.style.position = "relative"), (o.contentEditable = "true")),
                (o.disabled = !1),
                (e.editorUpload = Tw(e)),
                (e.schema = ca(aO(e))),
                (e.dom = Oa(n, {
                    ...
                    ((e) => {
                        ((e) => {
                            const t = [",", ".", ";", ":", "!", "?"],
                                n = [32],
                                o = () => {
                                    return (t = Qd(e)), (n = Jd(e)), { inlinePatterns: ml(t), blockPatterns: ul(t), dynamicPatternsLookup: n };
                                    var t, n;
                                },
                    ...
                    : ((e, t) => {
                        ((e, t) => {
                            const n = e.translate("Rich Text Area"),
                                ...
                                r = ((e, t, n, o) => {
                                    const r = hn("iframe");
                                    return o.each((e) => Qt(r, "tabindex", e)), Jt(r, n), Jt(r, { id: e + "_ifr", frameBorder: "0", allowTransparency: "true", title: t }), cn(r, "tox-edit-area__iframe"), r;
                                })(e.id, n, wl(e), o).dom;
                            (r.onload = () => {
                                ...
                                (e.iframeHTML = ((e) => {
                                    ...
                                    const n = El(e),
                                        ...
                                        r = e.translate(Bd(e));
                                    return (
                                        _l(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + _l(e) + '" />'),
                            ...
                            t.editorContainer && ((t.editorContainer.style.display = e.orgDisplay), (e.hidden = mO.isHidden(t.editorContainer))),
        ...
        NO = (e, t) => ({ table_grid: !1, object_resizing: !1, resize: !1, toolbar_mode: xe(e, "toolbar_mode").getOr("scrolling"), toolbar_sticky: !1, ...(t ? { menubar: !1 } : {}) }),
        RO = (e, t) => {
            var n;
            ...
            I.from(n)
                ...
                .bind((n) =>
                    ((e, t, n) =>
                        bb(
                            vn(n),
                            (t) => ((t) => co(t, e).orThunk(() => (PO(t) ? xe(DO, e).bind((e) => en(t, e)) : I.none())))(t),
                            (e) => kn(vn(t), e)
                    ...
                    ((e) => {
                        ...
                        ((e) => {
                            ...
                            e.editorCommands.addCommands({ "Bold,Italic,Underline,Strikethrough,Superscript,Subscript": (e) => t(e), mceBlockQuote: () => t("blockquote") }, "state"),
                                e.editorCommands.addQueryValueHandler("FontName", () => ((e) => UO(e, (t) => IO(e.getBody(), t.dom)).getOr(""))(e)),
                                e.editorCommands.addQueryValueHandler("FontSize", () => ((e) => UO(e, (t) => MO(e.getBody(), t.dom)).getOr(""))(e)),
    ...
    const sT = (e, t) => {
                ...
                "focus" !== e &&
                    ...
                    (n.removed ||
                        (t
                            ...
                            : n.initialized && n.delegates && (n.dom.unbind(sT(n, e), e, n.delegates[e]), delete n.delegates[e])));
            },
        ...
        dT = (e) => (m(e) ? { value: e.split(/[ ,]/), valid: !0 } : k(e, m) ? { value: e, valid: !0 } : { valid: !1, message: "The value must be a string[] or a comma/space separated string." }),
        ...
        pT = Dt.each,
        hT = Dt.explode,
        bT = { f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123 },
    ...
    class ST {
        constructor(e, t, n) {
            ...
            (this.options = ((e, t) => {
                ...
                ((e) => {
                    ...
                    t("id", { processor: "string", default: e.id }),
                        ...
                        t("text_patterns", {
                            processor: (e) => (k(e, f) || !1 === e ? { value: fl(!1 === e ? [] : e), valid: !0 } : { valid: !1, message: "Must be an array of objects or false." }),
                            default: [
                        ...
                        t("noneditable_regexp", { processor: (e) => (k(e, bl) ? { value: e, valid: !0 } : bl(e) ? { value: [e], valid: !0 } : { valid: !1, message: "Must be a RegExp or an array of RegExp." }), default: [] }),
                        ...
                        e.on("ScriptsLoaded", () => {
                            t("directionality", { processor: "string", default: Ia.isRtl() ? "rtl" : void 0 }), t("placeholder", { processor: "string", default: hl.getAttrib(e.getElement(), "placeholder") });
                        });
                })(o);
            ...
            c && (At.cacheSuffix = c.replace(/^[\?\&]+/, "")),
                (this.ui = { registry: wT(), styleSheetLoader: void 0, show: E, hide: E, setEnabled: E, isEnabled: M }),
                (this.mode = ((e) => {
                    const t = Da("design"),
        ...
        render() {
            ((e) => {
                ...
                e.on("remove", () => {
                    ...
                    (e.ui.styleSheetLoader = ((e, t) => Ps.forElement(e, { contentCssCors: Sd(t), referrerPolicy: ql(t) }))(o, e)),
                    hd(e) ? (e.inline = !0) : ((e.orgVisibility = e.getElement().style.visibility), (e.getElement().style.visibility = "hidden"));
                const s = e.getElement().form || bO.getParent(t, "form");
                s &&
                    ((e.formElement = s),
                        bd(e) && !Yo(e.getElement()) && (bO.insertAfter(bO.create("input", { type: "hidden", name: t }), t), (e.hasHiddenInput = !0)),
                        ...
                        !vd(e) || s.submit.nodeType || s.submit.length || s._mceOldSubmit || ((s._mceOldSubmit = s.submit), (s.submit = () => (e.editorManager.triggerSave(), e.setDirty(!1), s._mceOldSubmit(s))))),
        ...
        hide() {
            ...
            e.hidden ||
                (e.save(),
                    e.inline ? ((e.getBody().contentEditable = "false"), e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (xT.hide(e.getContainer()), xT.setStyle(e.id, "display", e.orgDisplay)),
                    (e.hidden = !0),
                    e.dispatch("hide"));
        }
        isHidden() {
        ...
        resetContent(e) {
            void 0 === e ? KC(this, this.startContent, { format: "raw" }) : KC(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged();
        }
        isDirty() {
        ...
        destroy(e) {
            ((e, t) => {
                ...
                e.destroyed ||
                    (t || e.removed
                        ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), aw(n), aw(o)),
                            ((e) => {
    ...
    const TT = (e) => {
        ...
        LT = {
                        ...
                        (i = ((e, t) => {
                            ...
                            ((e) =>
                                At.browser.isIE() || At.browser.isEdge()
                                    ? (kw("TinyMCE does not support the browser you are using. For a list of supported browsers please see: https://www.tiny.cloud/docs/tinymce/6/support/#supportedwebbrowsers"), [])
                                    : PT
            ...
            remove(e) {
                ...
                let n;
                if (e) {
                    if (!m(e)) return (n = e), h(t.get(n.id)) ? null : (DT(n) && t.dispatch("RemoveEditor", { editor: n }), 0 === OT.length && window.removeEventListener("beforeunload", RT), n.remove(), BT(OT.length > 0), n);
                    NT(_T.select(e), (e) => {
    ...
    const qT = {
        ...
        dom: { EventUtils: Ca, TreeWalker: Fo, TextSeeker: ii, DOMUtils: Oa, ScriptLoader: Ba, RangeUtils: Pf, Serializer: WC, StyleSheetLoader: Ds, ControlSelection: af, BookmarkManager: Km, Selection: $C, Event: Ca.Event },
        html: { Styles: ua, Entities: Qs, Node: Ug, Schema: ca, DomParser: nC, Writer: Gg, Serializer: Yg },
        Env: At,
        AddOnManager: Fa,
        Annotator: Wm,
        Formatter: Hw,
